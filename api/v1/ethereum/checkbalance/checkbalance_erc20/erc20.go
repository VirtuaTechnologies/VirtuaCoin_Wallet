...
import (
	...
	"github.com/VirtuaTechnologies/VirtuaCoin_Wallet/pkg/network/ethereum"
...
func erc20CheckBalanceSalt(c *gin.Context) {
	...
	balance, err := ethereum.GetERC20BalanceInDecimalsFromWalletAddress(common.HexToAddress(paramWalletAddress), common.HexToAddress(paramContractAddress))
	if err != nil {
